...
subexpStr = num2str(subexpStrSh, '%02d'); % 02 03,...
% subexpStr_al = {'02','03','04','05','06','07','08','09','10'};
% -

% for isub = 1:length(subexpStr_al) 
...
save_c_dir = [exp_dir '/c_noh/lp' num2str(tloop,'%02d') '/Z' num2str(ik,'%02d')];
...
volPerPtcl0_1d = perBin2perPtcl_gen(volPerBin./ds.numptcls_perbin ...
