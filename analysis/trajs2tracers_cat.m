...
trajs_orig_dir = [campdir '/lagr_study/exp1/trajs_cubic/lp' num2str(tloop,'%02d') '/Z' num2str(ik,'%02d') '/'];
...
xin1d = ds_params.xin1d;
yin1d = ds_params.yin1d;
...
volPerPtcl0_1d = perBin2perPtcl_gen(volPerBin./2048 ...
